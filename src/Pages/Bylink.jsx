...
useEffect(() => {
  ...
  //let sltid=-1
    axios.get(`${baseurl}/Viewer?stid=${staffid}`)
    .then((r)=>{
     //   console.log(r.data)
        setviewers(r.data)
...
<tr style={{backgroundColor:'lightgray'}}>
        ...
        <th style={{backgroundColor:'lightgray'}}  ><button type="button"  class="btn btn-secondary" onClick={GotoStaffdash} >Dashboard</button></th>
    ...
    <table className="table">
      ...
      <thead>
    {/*  <tr style={{backgroundColor:'lightgray'}}>
        <th style={{backgroundColor:'lightgray',color:'black'}} colSpan={8}><h4>Guruvayur Devoswam</h4></th>
        <th style={{backgroundColor:'lightgray'}}  ><button type="button"  class="btn btn-secondary" onClick={GotoHome} >By Link</button></th>
        <th style={{backgroundColor:'lightgray',float:'right'}}  ><button type="button"  class="btn btn-secondary" onClick={GotoHome} >Home</button></th>
      </tr>*/
    }
        <tr>
